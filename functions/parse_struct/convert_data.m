...
if isfield(data.environment, "exoplanet_position")
...
if isfield(data.instrument, "phase_shifts")
    [data.instrument.baselines, data.instrument.unique_baselines] = ...
        classify_baselines(data.instrument.intensities, ...
        data.instrument.positions, data.instrument.phase_shifts, false);
end
